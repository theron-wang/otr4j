...
public final class AuthRMessages {
     ...
     * @param ourClientProfile        our ClientProfile instance
     ...
     */
    public static void validate(@Nonnull final AuthRMessage message, @Nonnull final ClientProfile ourClientProfile,
        ...
        ringVerify(ourClientProfile.getLongTermPublicKey(), message.getClientProfile().getLongTermPublicKey(),
