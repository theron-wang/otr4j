...
// TODO Consider replacing '.getCanonicalName()' with '.getName()'
// TODO consider if it makes sense to have some kind of SecurityManager rule/policy that prevents code from inspecting any otr4j instances.
/**
 * otr4j.
 */
