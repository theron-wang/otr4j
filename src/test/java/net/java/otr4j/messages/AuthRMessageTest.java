...
public final class AuthRMessageTest {
    ...
    private static final ClientProfilePayload PAYLOAD = ClientProfilePayload.sign(
            new ClientProfile(SMALLEST_TAG, ED_DSA_KEYPAIR.getPublicKey(), FORGING_KEY,
                    Collections.singleton(OTRv.FOUR), DSA_KEYPAIR.getPublic()),
    ...
    public void testConstruction() {
        ...
        final AuthRMessage message = new AuthRMessage(OTRv.FOUR, SMALLEST_TAG, HIGHEST_TAG, PAYLOAD, X, A, sigma);
    ...
    public void testConstructionIllegalProtocolVersionOne() {
        final byte[] m = randomBytes(RANDOM, new byte[150]);
        final Sigma sigma = generateSigma(ED_DSA_KEYPAIR, m);
        new AuthRMessage(OTRv.ONE, SMALLEST_TAG, HIGHEST_TAG, PAYLOAD, X, A, sigma);
    }
    ...
    public void testConstructionIllegalProtocolVersionTwo() {
        final byte[] m = randomBytes(RANDOM, new byte[150]);
        final Sigma sigma = generateSigma(ED_DSA_KEYPAIR, m);
        new AuthRMessage(OTRv.TWO, SMALLEST_TAG, HIGHEST_TAG, PAYLOAD, X, A, sigma);
    }
    ...
    public void testConstructionIllegalProtocolVersionThree() {
        final byte[] m = randomBytes(RANDOM, new byte[150]);
        final Sigma sigma = generateSigma(ED_DSA_KEYPAIR, m);
        new AuthRMessage(OTRv.THREE, SMALLEST_TAG, HIGHEST_TAG, PAYLOAD, X, A, sigma);
    }
    ...
    public void testConstructionNullSenderTag() {
        final byte[] m = randomBytes(RANDOM, new byte[150]);
        final Sigma sigma = generateSigma(ED_DSA_KEYPAIR, m);
        new AuthRMessage(OTRv.FOUR, null, HIGHEST_TAG, PAYLOAD, X, A, sigma);
    }
    ...
    public void testConstructionNullReceiverTag() {
        final byte[] m = randomBytes(RANDOM, new byte[150]);
        final Sigma sigma = generateSigma(ED_DSA_KEYPAIR, m);
        new AuthRMessage(OTRv.FOUR, SMALLEST_TAG, null, PAYLOAD, X, A, sigma);
    }
    ...
    public void testConstructionNullClientProfilePayload() {
        final byte[] m = randomBytes(RANDOM, new byte[150]);
        final Sigma sigma = generateSigma(ED_DSA_KEYPAIR, m);
        new AuthRMessage(OTRv.FOUR, SMALLEST_TAG, HIGHEST_TAG, null, X, A, sigma);
    }
    ...
    public void testConstructionNullX() {
        final byte[] m = randomBytes(RANDOM, new byte[150]);
        final Sigma sigma = generateSigma(ED_DSA_KEYPAIR, m);
        new AuthRMessage(OTRv.FOUR, SMALLEST_TAG, HIGHEST_TAG, PAYLOAD, null, A, sigma);
    }
    ...
    public void testConstructionNullA() {
        final byte[] m = randomBytes(RANDOM, new byte[150]);
        final Sigma sigma = generateSigma(ED_DSA_KEYPAIR, m);
        new AuthRMessage(OTRv.FOUR, SMALLEST_TAG, HIGHEST_TAG, PAYLOAD, X, null, sigma);
    }

    @Test(expected = NullPointerException.class)
    public void testConstructionNullSigma() {
        new AuthRMessage(OTRv.FOUR, SMALLEST_TAG, HIGHEST_TAG, PAYLOAD, X, A, null);
    }
