...
public class OtrFragmenterTest {
	...
	private static final OtrPolicy POLICY_V23 = new OtrPolicy(OtrPolicy.ALLOW_V2 | OtrPolicy.ALLOW_V3);
	private static final OtrPolicy POLICY_V3 = new OtrPolicy(OtrPolicy.ALLOW_V3);
	private static final OtrPolicy POLICY_V2 = new OtrPolicy(OtrPolicy.ALLOW_V2);
	private static final OtrPolicy POLICY_V1 = new OtrPolicy(OtrPolicy.ALLOW_V1);
