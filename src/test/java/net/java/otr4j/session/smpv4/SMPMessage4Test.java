...
public final class SMPMessage4Test {
    ...
    public void testVerifyEncoding() {
        final byte[] expected = new byte[] {0, 0, 0, 57, -19, -122, -109, -22, -51, -5, -22, -38, 107, -96, -51, -47, -66, -78, -68, -69, -104, 48, 42, 58, -125, 101, 101, 13, -72, -60, -40, -118, 114, 109, -29, -73, -41, 77, -120, 53, -96, -41, 110, 3, -80, -62, -122, 80, 32, -42, 89, -77, -115, 4, -41, 74, 99, -23, 5, -82, -128, 0, 0, 0, 1, 1, 0, 0, 0, 1, 2};
        final Point rb = basePoint().multiply(valueOf(2L));
        final BigInteger cr = valueOf(1L);
        final BigInteger d7 = valueOf(2L);
        final SMPMessage4 message = new SMPMessage4(rb, cr, d7);
